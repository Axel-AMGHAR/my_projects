...
<div class="h-screen flex items-center justify-center">
    <div class="italic font-extrabold " style="transform: skewX(-8deg);">
        <div class="rounded-tl-xl py-4 px-8 bg-green-900 text-5xl leading-none">
            <h1 class="text-white ml-2">SUMMER 2020</h1>
            <h1 class="text-green-300">SUMMER 2020 - 25</h1>
        </div>
        <span class="text-3xl">
            <div class="flex flex-row justify-around bg-green-600 py-4 px-8">
                <div class="">
                    <h2 class="text-white">RECORD PERSONEL</h2>
                    <img class="w-20 m-auto mt-4" style="transform: skewX(8deg);" src="{{asset('img/medal.png')}}" alt="">
                </div>
